...

{
  ...
  fileSystems."/" =
    { device = "/dev/disk/by-uuid/047ae7e8-5c63-4d7b-bca1-597609f91946";
      fsType = "xfs";
    };

  fileSystems."/boot" =
    { device = "/dev/disk/by-uuid/CF97-DC5D";
      fsType = "vfat";
  ...
  swapDevices =
    [ { device = "/dev/disk/by-uuid/f971cbf8-e418-43fc-9a1e-920ecc840809"; }
    ];
