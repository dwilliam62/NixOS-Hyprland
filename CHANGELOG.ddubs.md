...
- Updated fonts in package.nix for new format in unstable 
- Updated yazi 
- Updated Hyprland 
...
### 1-24-25
  ...
  - Set explorer kernel to 6.12 until 6.13 builds
   ...
   - Added chaotic-nyx to flake input 
...
### 1-3-25
  ...
  - Moved Hyprland pacakges to host files
  - Updated jak-nixos vm to GDM but have block cursor w/hyprland 
  - Added old hyprland url
...
### 1-2-25
  ...
  - Removed lightdm switched to GDM, enabled wayland support
  - Tried enabling river w/archcrapft config Starts but blank screen
  - Reorganizing packages.nix by catagory
  - New kernel 6.12.8
